...
-- Libro de Reclamaciones: los datos se conservan para atender el caso y
-- cumplir las obligaciones de atención al consumidor.
...
CREATE INDEX consumer_claims_created_idx ON consumer_claims (created_at DESC);
